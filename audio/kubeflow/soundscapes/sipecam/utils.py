...
def parser(datum):
    ...
    web_dav_local_path = os.path.join("/shared_volume/webdav_alfresco/Sites/sipecam/documentLibrary", cumulo)
    ...
    filesize = float(properties["sipecamAudio:FileSize"].replace(" MiB", ""))*(2**20)
