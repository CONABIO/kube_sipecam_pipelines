...
def get_audio_df(AUTH_ENDPOINT: str, BASE_ENDPOINT: str, CUMULO: int, LIMIT: bool, PAGESIZE: int, SAMPLERATE: float):
    ...
    _kale_marshal.set_data_dir("/shared_volume/audio/.soundscape-sipecam-cumulus-node-recorder-deployment.ipynb-aws.ipynb.kale.marshal.dir")
...
@_kfp_dsl.pipeline(
    name='sound-scape-nod-rec-dep-8ov5v',
...
if __name__ == "__main__":
    ...
    run_name = generate_run_name('sound-scape-nod-rec-dep-8ov5v')
